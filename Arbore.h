...
public:
    Arbore();
    Arbore(int cop_nr_orase, int cop_nrstrazi,int cop_radacina,vector <pair<double, double>> cop_coordonate_orase, vector<vector<pair<int, double>>> cop_oras_distanta);
    ~Arbore();
